...
const UnmappedPage = {
    ...
    _renderTable(rows) {
        ...
        wrap.querySelectorAll(".btn-mapping").forEach(btn => {
            btn.addEventListener("click", () => {
                this._openModal(btn.dataset.itemno);
            });
        });
    ...
    _openModal(itemNo) {
        ...
        const sub =
            document.getElementById("unmappedMappingItemNo");

        const input =
            document.getElementById("unmappedVariantKode");
    ...
    async _doSaveMapping() {
        ...
        const btn =
            document.getElementById("unmappedMappingSave");
